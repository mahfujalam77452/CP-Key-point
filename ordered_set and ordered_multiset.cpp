...
//here int is what type of value you want to insert
//less<int> is your compression.
//it can be greater<int> for descending order.
//it can be less_equal for acting like multiset.
int main() {
	pbds A; // declaration
